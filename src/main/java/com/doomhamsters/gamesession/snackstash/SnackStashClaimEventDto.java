...
public class SnackStashClaimEventDto {
  ...
  /**
   * Creates a defensive copy of another claim event.
   *
   * @param other claim event to copy
   */
  public SnackStashClaimEventDto(SnackStashClaimEventDto other) {
    this.claimId = other.claimId;
    this.playerId = other.playerId;
    this.playerName = other.playerName;
    this.votesRequired = other.votesRequired;
    this.votesReceived = other.votesReceived;
    this.votedPlayerIds =
        other.votedPlayerIds == null ? List.of() : List.copyOf(other.votedPlayerIds);
